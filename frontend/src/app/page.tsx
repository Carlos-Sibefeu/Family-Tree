    ...
    <PublicLayout>
      <div className="space-y-12">
        ...
        <section className="bg-white rounded-lg shadow-md p-8 text-center">
          <h1 className="text-4xl font-bold text-blue-800 mb-4">Découvrez Votre Histoire Familiale</h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link 
              href="/login" 
              className="bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 font-medium py-3 px-6 rounded-md transition-colors"
            >
              Se connecter
            </Link>
          </div>
        ...
        <section className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            <div className="p-4">
              <div className="bg-blue-100 text-blue-800 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 font-bold text-xl">1</div>
            ...
            <div className="p-4">
              <div className="bg-blue-100 text-blue-800 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 font-bold text-xl">2</div>
            ...
            <div className="p-4">
              <div className="bg-blue-100 text-blue-800 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 font-bold text-xl">3</div>
            ...
            <div className="p-4">
              <div className="bg-blue-100 text-blue-800 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 font-bold text-xl">4</div>
        ...
        {/* Call to Action */}
        <section className="bg-blue-700 text-white rounded-lg shadow-md p-8 text-center">
          ...
          <Link 
            href="/membership/apply" 
            className="bg-white text-blue-700 hover:bg-blue-50 font-medium py-3 px-8 rounded-md transition-colors inline-block"
          >
            Faire une demande d'adhésion
          </Link>
        </section>
