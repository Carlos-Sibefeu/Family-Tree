...
/**
 * Route API pour trouver le chemin le plus court entre deux personnes
...
export async function POST(req: NextRequest) {
  try {
    ...
    const shortestPath = familyGraph.findShortestPath(person1Id, person2Id);
    ...
    console.error('Erreur lors de la recherche du chemin le plus court:', error);
    return NextResponse.json(
